...
<div class="wrap card parent-section" id="parent-compravendita">
  <form method="post" id="mainForm">
    ...
    <div id="nuovoval" class="tabcontent">
      <div class="row"><label>Street price (prezzo giusto di vendita)</label><input type="text" id="street_price" name="street_price" value="{{ formvals.street_price }}" oninput="updatePreviewVal();updatePreviewVendita();"></div>
...
<div class="wrap card parent-section" id="parent-affitti" style="display:none">
  ...
  <p class="muted">Dimmi quali campi vuoi prima (es. canone mensile, mesi vacanza/anno, IMU/TASI, assicurazione, gestione, manutenzione, ecc.) e li integro.</p>
</div>
...
document.addEventListener('DOMContentLoaded',()=>{
  ...
  // Child default per Compravendita
...
def compute_results(form):
    ...
    perc_map = {"none":0,"nessuna":0,"piccola":0.10,"intermedia":0.20,"complessa":0.60}
    ...
    # formvals aggiornati per i read-only
...
@app.route("/reset")
def reset():
    # torna alla pagina senza risultati (riepilogo nascosto)
